...
class LLMSettings(BaseSettings):
    """Settings for LLM (Large Language Model) integration.

    All settings are prefixed with 'LLM_' in environment variables.
    ...
    Attributes:
        ...
        PDF_RENDER_DPI: DPI for rendering PDF pages to images.
